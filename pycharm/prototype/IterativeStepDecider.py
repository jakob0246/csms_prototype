...
def decide_iterative_step(main_iteration, evaluation_results, algorithm_scores, algorithms_knowledge_db, history, kdb_update_count, old_selected_algorithm, max_iterations, supervised=False):
    ...
    high_accuracy_threshold = 0.95  # TODO: change regarding user preference
    ...
    if evaluation_results["accuracy"] > high_accuracy_threshold:
        ...
        if main_iteration == (max_iterations - 1):  # TODO: no iterations left
            ...
            if main_iteration == 0:
                ...
                if (supervised and history[main_iteration - 1]["selected_next_best_algorithm"] and evaluation_results["accuracy"] + previous_accuracy_threshold < history[main_iteration - 1]["results"]["accuracy"]) or \
                   ((not supervised) and history[main_iteration - 1]["selected_next_best_algorithm"] and False):  # TODO
